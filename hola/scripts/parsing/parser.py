...
from scripts.tokenizing import token as toooken
from scripts.tokenizing.token import TokenType, Token
from scripts.misc import node as noooode
    ...
    def parse_token_list(self, values, sep = ","):
        ...
        for token in values:
            ...
            if token.token_type.is_opening_bracket():
                ...
                corresponding_end = BRACKET_PAIRS[token.value]
